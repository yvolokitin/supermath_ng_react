// exchange user info tab translations
export const welcome = {
    ...
    'en': {
        ...
        'thanks': 'Thanks to your friend ',
        'extra': ', you get extra 200 bonus smiles that you can exchange in your account!',
    ...
    'ru': {
        ...
        'thanks': 'Благодаря своему другу ',
        'extra': ', ты получил 200 дополнительных бонусных балов, которые ты сможешь обменять в личном кабинете!',
    ...
    'nl' : {
        ...
        'thanks': 'Dank aan je vriend ',
        'extra': ', je krijgt 200 extra bonusglimlachen die je in je account kunt inwisselen!',
    ...
    'fr' : {
        ...
        'thanks': 'Merci à ton ami ',
        'extra': ', vous obtenez 200 sourires bonus supplémentaires que vous pouvez échanger sur votre compte!',
    ...
    'de' : {
        ...
        'thanks': 'Danke an deinen Freund ',
        'extra': ', sie erhalten zusätzlich 200 Bonuslächeln, die Sie auf Ihrem Konto eintauschen können!',
    ...
    'es' : {
        ...
        'thanks': 'Gracias a tu amiga ',
        'extra': ', obtienes 200 sonrisas adicionales que puedes intercambiar en tu cuenta.',
    ...
    'it' : {
        ...
        'thanks': 'Grazie al tuo amico ',
        'extra': ', ottieni 200 sorrisi bonus extra che puoi scambiare nel tuo account!',
