...
export const taskgame = {
    ...
    'de' : {
        'error': 'Fehler: ',
        'image': 'Fehler: Bild konnte nicht geladen werden, empfangener Antwortcode ',
    ...
    'es' : {
        'error': 'Error: ',
        'image': 'Error: no se pudo cargar la imagen, se recibió el siguiente código de respuesta ',
    ...
    'it' : {
        'error': 'Errore: ',
        'image': 'Errore: impossibile caricare l\'immagine, ricevuto il seguente codice di risposta',
