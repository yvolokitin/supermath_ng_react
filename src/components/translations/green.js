...
export const green_titles = {
    // English
    'en': {
        '1': 'Addition and Subtraction of hundreds (100..900)',
        '2': 'Addition and Subtraction of tens and hundreds',
        '3': 'Addition and Subtraction of round numbers (two and three digit)',
        '4': 'Long Addition and Subtraction of two- and three- digit numbers',
        '5': 'Comparison of two expressions of tens (10..90)',
        '6': 'Comparison of two expressions of two digit numbers',
...
export const green_descriptions = {
    ...
    // Russian
    'ru': {
        '1': 'Сложение и Вычитание сотен: 100, 200, 300, 400, 500, 600, 700, 800, 900 и 1000 (1000 - единственное четырехзначное число, используемое в данных задачах, как исключение). ',
        '2': 'Сложение и Вычитание десятков и сотен. ',
        '3': 'Сложение и Вычитание двух круглых чисел (сотни и десятки).',
        '4': 'Сложение и Вычитание в столбик трёх- и двузначных чисел',
        ...
        '8': 'Задача в разработке или еще не до конца готова',
        '9': 'Задача в разработке или еще не до конца готова',
    },
    // Dutch
    'nl' : {
        '1': 'Tasks for multiplication of one-digit numbers from 0 to 5. Multiplication often denoted by the cross symbol x or by an asterisk * or dot. For example: 3 x 1 = 3, 3 x 3 = 9 or 5 x 3 = 15.',
