...
export const white_descriptions = {
    ...
    'en': {
        ...
        '10': 'The White Belt test includes the following programs: determining a one-digit number by sequence; comparison of two single-digit numbers (from 0 to 10); addition and subtraction of two single-digit numbers (from 0 to 10); definition of arithmetic operation (addition or subtraction); addition and subtraction of three single-digit numbers (from 0 to 10); comparison of expressions of two single-digit numbers (from 0 to 10). Programs are randomly selected and limited by time for response (10 seconds max per each task).',
    },
    // Russian
    'ru': {
        '1': 'Задачи на Определение однозначного числа по приведенной последовательности в порядке возрастания или убывания. Учащемуся даны 3 последовательных числа, например 1-2-3-?, и необходимо определить четвертое (последнее число). Числа обязательно указаны по порядку и могут следовать по возрастанию или убыванию. Число, которое необходимо определить — помечено знаком вопроса. Например, 4-5-6-? (правильный ответ 7) или 5-4-3-? (правильный ответ 2).',
        ...
        '10': 'Тест на Белый пояс включает в себя прохождение следующих программ: определение однозначного числа по последовательности; сравнение двух однозначных чисел (от 0 до 10); сложение и вычитание двух однозначных чисел (от 0 до 10); определение арифметической операции (сложение или вычитание); сложение и вычитание трех однозначных чисел (от 0 до 10); сравнение выражений двух однозначных чисел (от 0 до 10). Программы выбираются в случайном порядке и ограничены по времени для ответа (10 секунд максимум на решение одной задачи).',
    },
    // Dutch
    'nl' : {
        '1': 'Tasks for one-digit numbers (from 0 to 9) sequences, where kids have three consecutive numbers (for example: 1, 2, 3) and have to understand the next (fourth - 4). The last number displayed with questionmark. Number sequences can be ascending (example, 4-5-6-?) and descending (example, 5-4-3-?)',
